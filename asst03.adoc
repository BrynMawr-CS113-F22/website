...
the ISBN number for _Harry Potter and the Socerer's Stone_ is 978059035
...
for _Harry Potter_'s ISBN number, stem:[d_{10}] is 9; stem:[d_9] is 7; stem:[d_8] is 8; etc.
...
Features, Hints and Requirements:
...
individually to a digit. One way to do this is use the function `Character.getNumericValue(c);` .
For example, 
[source]
----
