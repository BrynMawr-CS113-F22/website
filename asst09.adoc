...
*Due [.line-through]#Thursday, November 17# Wednesday November 23rd, before midnight*
...
* You are given a function `searchCategoryByKeyword` that returns an array of restaurants which match the keyword. Study this function to see examples of
